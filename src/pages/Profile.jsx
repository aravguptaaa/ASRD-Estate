    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <div className='bg-gray-100 p-4 rounded-lg mt-5'>
        ...
        <button
          ...
          className='bg-green-700 text-white rounded-lg p-3 mt-3 w-full uppercase hover:bg-green-800'
        >
          Show Listings
        </button>
      </div>
      ...
      <button
        onClick={handleShowListings}
        className='bg-green-700 text-white rounded-lg p-3 mt-5 w-full uppercase hover:bg-green-800'
      >
        Show Listings
      </button>
      <p className='text-red-700 mt-5 font-bold'>
        {showListingsError ? 'Error: Failed to show listings' : ''}
      </p>
